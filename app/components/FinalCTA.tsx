  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Escríbenos por WhatsApp y recibe tu propuesta en menos de 24 horas.
          Paga solo si te encanta.
        </motion.p>
        ...
        >
          {/* Primary CTA: WhatsApp with auto-shine */}
          <motion.a
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center justify-center gap-3 bg-white text-gray-900 px-10 py-5 rounded-full text-lg md:text-xl font-semibold min-h-[64px] overflow-hidden isolate active:scale-[0.97] transition-transform shadow-2xl shadow-rose-primary/20"
